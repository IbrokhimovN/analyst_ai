...
urlpatterns = [
    ...
    path('ai/reports/', ai.GeneratedReportsView.as_view(), name='ai-reports'),
    path('ai/alerts/', ai.MetricAlertsView.as_view(), name='ai-alerts'),
    path('ai/feedback/', ai.ChatFeedbackView.as_view(), name='ai-feedback'),
    path('ai/export/', ai.AnalyticsExportView.as_view(), name='ai-export'),
